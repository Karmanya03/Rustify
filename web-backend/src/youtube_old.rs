...
// Simple function to detect yt-dlp command
fn get_yt_dlp_command() -> String {
    // For Render.com and most hosting, use direct yt-dlp
    if std::env::var("RENDER").is_ok() || std::env::var("NODE_ENV").map_or(false, |v| v == "production") {
